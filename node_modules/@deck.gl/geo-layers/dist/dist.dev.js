...
var __exports__ = (() => {
  ...
  var isBrowser3 = typeof process !== "object" || String(process) !== "[object process]" || process.browser;
  ...
  function extractEXBoundingBox(xmlBoundingBox) {
    const { westBoundLongitude: w, northBoundLatitude: n2, eastBoundLongitude: e, southBoundLatitude: s2 } = xmlBoundingBox;
    return [
      [w, s2],
      [e, n2]
    ];
...
`;
  ...
  var VERSION10 = true ? "4.2.0-beta.2" : "latest";
  ...
  var Delatin = class {
    ...
    _addTriangle(a2, b, c, ab, bc, ca, e = this.triangles.length) {
      const t2 = e / 3;
  ...
  var VERSION11 = true ? "4.2.0-beta.2" : "latest";
  ...
  var VERSION12 = true ? "4.2.0-beta.2" : "latest";
  var MVTWorkerLoader = {
    dataType: null,
    batchType: null,
