...
export declare class WEBGLTexture extends Texture<WEBGLTextureProps> {
    ...
    _deduceParameters(opts: WEBGLTextureProps): {
        ...
        data: string | HTMLVideoElement | import("@luma.gl/core").TextureData | Promise<import("@luma.gl/core").TextureData> | import("modules/core/dist/adapter/resources/texture").CubeTextureData;
    };
